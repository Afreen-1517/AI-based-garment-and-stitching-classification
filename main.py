...
main = Tk('Transfer Learning for Garment Type Classification Using the StitchingNet Dataset')
...
title = Label(
    main,
    text="Transfer Learning For Garment Type Classification Using The Stitchingnet Dataset",
    font=('times', 20, 'bold'),
    bg='lightblue'
)
